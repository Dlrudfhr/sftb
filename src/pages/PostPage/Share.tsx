...
import "../../assets/css/Coding.css"; /* 스타일 참조 */
...
const Share = () => {
  ...
  const handlePostWrite = () => {
    navigate("/PostWrite", { state: { boardId: 1 } }); // Board_ID가 1
  };
  ...
  return(
    ...
    <Header />
      <div className="post_layout">
        <h1 className="post_title">과목별 정보 공유 게시판</h1>
        ...
        <div className="Coding_Number">
          ...
          <Link to="/PostWrite" state={{ boardId: 3 }}>
