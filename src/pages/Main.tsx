  ...
  return (
    <article className="Main_content" ref={highElement}>
      ...
      <div className="Main_info_cate" id="Main_study_card" >
        <div className="Main_category_title" ref={secondElement}>공부해요!</div>
        <ul>
          {/*멘토멘티 게시판 카드 */}
          <li>
      ...
      <div className="Main_info_cate" id="Main_else_card" >
        <div className="Main_category_title" ref={thirdElement}>장터</div>
          <ul>
            {/*전공책 장터 게시판 카드 */}
            <li>
      ...
      {/*나머지 카테고리 카드 */}
      <div className="Main_info_cate" id="Main_else_card" >
        <div className="Main_category_title" ref={fourthElement}>기록열람</div>
        <ul>
          {/*장부기록 공개 게시판 카드 */}
          <li>
