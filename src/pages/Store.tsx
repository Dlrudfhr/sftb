...
const Store: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [bgImage, setBgImage] = useState("url('../assets/images/자판기_초록.png')"); 
  const handleClick = () => { 
    const newImage = bgImage === "url('../assets/images/자판기_초록.png')" ? "url('../assets/images/자판기_노랑.png')" : "url('../assets/images/자판기_초록.png')"; 
    setBgImage(newImage); 
      ...
      <div className="Store__background">
        <div className="Store__section">
          ...
          <div className="Store__category">
            ...
            <div className="Store__cateBtn" onClick={handleClick}>카페</div>
